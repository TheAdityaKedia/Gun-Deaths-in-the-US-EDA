...
year <- 2012
url <- "ftp://ftp.cdc.gov/pub/Health_Statistics/NCHS/Datasets/DVS/mortality/mort2016us.zip"
...
# For the project, we used the three most recent years available: 2012-16
...
all_guns <- rbind(guns_12, guns_13, guns_14, guns_15, guns_16)
all_guns <- all_guns %>%
  filter(res_status != 4)
